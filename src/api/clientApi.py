...
import client_response_wrappers as wrap
...
class UaClient:
	...
	def read_node_class_attribute(self, node_id):
		...
		return wrap.Read_node_class_attribute(status_code, out_node_id)
	...
	def read_browse_name_attribute(self, node_id):
		...
		return wrap.Read_browse_name_attribute_wrapper(status_code, out_browse_name)
	...
	def read_display_name_attribute(self, node_id):
		...
		return wrap.Read_display_name_attribute_wrapper(status_code, out_display_name)
	...
	def read_description_attribute(self, node_id):
		...
		return wrap.Read_description_attribute_wrapper(status_code, out_description)
	...
	def read_write_mask_attribute(self, node_id):
		...
		return wrap.Read_write_mask_attribute_wrapper(status_code, out_write_mask)
	...
	def read_user_write_mask_attribute(self, node_id):
		...
		return wrap.Read_user_write_mask_attribute_wrapper(status_code, out_user_write_mask)
	...
	def read_is_abstract_attribute(self, node_id):
		...
		return wrap.Read_is_abstract_attribute_wrapper(status_code, out_is_abstract)
	...
	def read_symmetric_attribute(self, node_id):
		...
		return wrap.Read_symmetric_attribute_wrapper(status_code, out_symmetric)
	...
	def read_inverse_name_attribute(self, node_id):
		...
		return wrap.Read_inverse_name_attribute_wrapper(status_code, out_inverse_name)
	...
	def read_contains_no_loops_attribute(self, node_id):
		...
		return wrap.Read_contains_no_loops_attribute_wrapper(status_code, out_contains_no_loops)
	...
	def read_event_notifier_attribute(self, node_id):
		...
		return wrap.Read_event_notifier_attribute_wrapper(status_code, out_event_notifier)
	...
	def read_value_attribute(self, nodeId):
		...
		return wrap.Read_value_attribute_wrapper(status_code, value)
	...
	def read_data_type_attribute(self, node_id):
		...
		return wrap.Read_value_attribute_wrapper(status_code, out_data_type)
	...
	def read_value_rank_attribute(self, node_id):
		...
		return wrap.Read_value_attribute_wrapper(status_code, out_value_rank)
	...
	def read_array_dimensions_attribute(self, node_id):
		...
		return wrap.Read_array_dimensions_attribute_wrapper(status_code, out_array_dimensions_size, out_array_dimensions)
	...
	def read_access_level_attribute(self, node_id):
		...
		return wrap.Read_access_level_attribute_wrapper(status_code, out_access_level)
	...
	def read_user_access_level_attribute(self, node_id):
		...
		return wrap.Read_user_access_level_attribute_wrapper(status_code, out_user_access_level)
	...
	def read_minimum_sampling_interval_attribute(self, node_id):
		...
		return wrap.Read_minimum_sampling_interval_attribute_wrapper(status_code, out_min_sampling_interval)
	...
	def read_executable_attribute(self, node_id):
		...
		return wrap.Read_executable_attribute_wrapper(status_code, out_executable)
	...
	def read_user_executable_attribute(self, node_id):
		...
		return wrap.Read_user_executable_attribute_wrapper(status_code, out_user_executable)
	...
	def call(self, object_id, method_id, input_size, input):
		...
		return wrap.Call_wrapper(status_code, output_size, output)
	...
	def add_variable_node(self, requested_new_node_id, parent_node_id, reference_type_id, browse_name, type_definition, attr = DefaultAttributes.VARIABLE_ATTRIBUTES_DEFAULT):
		...
		return wrap.Add_node_wrapper(status_code, out_new_node_id)
