...
class ReadNodeClassAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_node_id):
        self.status_code = status_code
        self.out_node_id = out_node_id


class ReadBrowseNameAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_browse_name):
        self.status_code = status_code
        self.out_browse_name = out_browse_name


class ReadDisplayNameAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_display_name):
        self.status_code = status_code
        self.out_display_name = out_display_name


class ReadDescriptionAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_description):
        self.status_code = status_code
        self.out_description = out_description


class ReadWriteMaskAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_write_mask):
        self.status_code = status_code
        self.out_write_mask = out_write_mask


class ReadUserWriteMaskAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_user_write_mask):
        self.status_code = status_code
        self.out_user_write_mask = out_user_write_mask


class ReadIsAbstractAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_is_abstract):
        self.status_code = status_code
        self.out_is_abstract = out_is_abstract


class ReadSymmetricAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_symmetric):
        self.status_code = status_code
        self.out_symmetric = out_symmetric


class ReadInverseNameAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_inverse_name):
        self.status_code = status_code
        self.out_inverse_name = out_inverse_name


class ReadContainsNoLoopsAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_contains_no_loops):
        self.status_code = status_code
        self.out_contains_no_loops = out_contains_no_loops


class ReadEventNotifierAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_event_notifier):
        self.status_code = status_code
        self.out_event_notifier = out_event_notifier


class ReadValueAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, value):
        self.status_code = status_code
        self.value = value


class ReadDataTypeAttribute:
    def __init__(self, status_code: ua_types.UaStatusCode, out_data_type):
        self.status_code = status_code
        self.value = out_data_type


class ReadValueRankAttribute:
    def __init__(self, status_code: ua_types.UaStatusCode, out_value_rank):
        self.status_code = status_code
        self.value = out_value_rank


class ReadArrayDimensionsAttributeResult:
    def __init__(self, status_code: ua_types.UaStatusCode, out_array_dimensions_size, out_array_dimensions):
        self.status_code = status_code
