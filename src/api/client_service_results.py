...
class WriteNodeIdAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_node_id):
        self.status_code = status_code
        self.req_id = req_id
        self.out_node_id = out_node_id


class WriteNodeClassAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_node_class):
        self.status_code = status_code
        self.req_id = req_id
        self.out_node_class = out_node_class


class WriteBrowseNameAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_browse_name):
        self.status_code = status_code
        self.req_id = req_id
        self.out_browse_name = out_browse_name


class WriteDisplayNameAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_display_name):
        self.status_code = status_code
        self.req_id = req_id
        self.out_node_id = out_display_name


class WriteDescriptionAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_description):
        self.status_code = status_code
        self.req_id = req_id
        self.out_description = out_description


class WriteWriteMaskAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_write_mask):
        self.status_code = status_code
        self.req_id = req_id
        self.out_write_mask = out_write_mask


class WriteUserWriteMaskAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_user_write_mask):
        self.status_code = status_code
        self.req_id = req_id
        self.out_user_write_mask = out_user_write_mask


class WriteIsAbstractAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_is_abstract):
        self.status_code = status_code
        self.req_id = req_id
        self.out_is_abstract = out_is_abstract


class WriteSymmetricAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_symmetric):
        self.status_code = status_code
        self.req_id = req_id
        self.out_symmetric = out_symmetric


class WriteInverseNameAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_inverse_name):
        self.status_code = status_code
        self.req_id = req_id
        self.out_description = out_inverse_name


class WriteContainsNoLoopsAttributeAsyncResult:
    def __init__(self, status_code, req_id, out_contains_no_loops):
        self.status_code = status_code
        self.req_id = req_id
        self.out_description = out_contains_no_loops





class AddVariableNodeAsyncResult:
    def __init__(self, status_code, req_id, out_contains_no_loops):
        self.status_code = status_code
        self.req_id = req_id
        self.out_description = out_contains_no_loops